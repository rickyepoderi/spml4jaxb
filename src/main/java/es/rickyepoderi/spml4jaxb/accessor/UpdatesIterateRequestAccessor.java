 ...
 * @author ricky
 */
public class UpdatesIterateRequestAccessor extends RequestAccessor<IterateRequestType, UpdatesIterateRequestBuilder> {

    public UpdatesIterateRequestAccessor(IterateRequestType request) {
