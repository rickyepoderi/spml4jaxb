 ...
 * @author ricky
 */
final class UnknownRequestAccessor extends RequestAccessor<RequestType, RequestAccessor, RequestBuilder> {

    protected UnknownRequestAccessor(RequestType request) {
    ...
    @Override
    public RequestAccessor asAccessor(RequestType request) {
        throw new IllegalStateException("Method not usable at this point, please use one of the \"as\" methods to transform into a real accessor.");
    }
