 ...
 * @author ricky
 */
public class ResetPasswordResponseAccessor extends BaseResponseAccessor<ResetPasswordResponseType, ResetPasswordResponseAccessor, ResetPasswordResponseBuilder> {
