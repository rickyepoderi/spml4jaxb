 ...
 * @author ricky
 */
public class ExpirePasswordResponseAccessor extends ResponseAccessor<ResponseType, ExpirePasswordResponseBuilder> {

    public ExpirePasswordResponseAccessor(ResponseType response) {
        super(response, null);
    }
