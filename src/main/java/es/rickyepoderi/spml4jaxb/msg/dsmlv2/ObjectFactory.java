 ...
 * generated in the es.rickyepoderi.spml2jaxb.msg.dsmlv2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Attr_QNAME = new QName("urn:oasis:names:tc:DSML:2:0:core", "attr");
    private final static QName _Modification_QNAME = new QName("urn:oasis:names:tc:DSML:2:0:core", "modification");
    private final static QName _Filter_QNAME = new QName("urn:oasis:names:tc:DSML:2:0:core", "filter");
    private final static QName _Attributes_QNAME = new QName("urn:oasis:names:tc:DSML:2:0:core", "attributes");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.rickyepoderi.spml2jaxb.msg.dsmlv2
     * 
     */
    ...
    @XmlElementDecl(namespace = "urn:oasis:names:tc:DSML:2:0:core", name = "attr")
    public JAXBElement<DsmlAttr> createAttr(DsmlAttr value) {
        return new JAXBElement<DsmlAttr>(_Attr_QNAME, DsmlAttr.class, DsmlAttr.class, value);
    }
    
    @XmlElementDecl(namespace = "urn:oasis:names:tc:DSML:2:0:core", name = "modification")
    public JAXBElement<DsmlModification> createModification(DsmlModification value) {
        return new JAXBElement<DsmlModification>(_Modification_QNAME, DsmlModification.class, DsmlModification.class, value);
    }
    
    @XmlElementDecl(namespace = "urn:oasis:names:tc:DSML:2:0:core", name = "filter")
    public JAXBElement<Filter> createFiler(Filter value) {
        return new JAXBElement<Filter>(_Filter_QNAME, Filter.class, Filter.class, value);
    }
    
    @XmlElementDecl(namespace = "urn:oasis:names:tc:DSML:2:0:core", name = "attributes")
    public JAXBElement<AttributeDescriptions> createAttributeDescriptions(AttributeDescriptions value) {
        return new JAXBElement<AttributeDescriptions>(_Attributes_QNAME, AttributeDescriptions.class, AttributeDescriptions.class, value);
    }
